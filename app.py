...
class PayrollManagement:
    ...
    def generate_payslip(employee_id, month, year):
        # Fetch employee details and salary components
        ...
        # Generate payslip using Granite AI
...
class GraniteAI:
    ...
    def analyze_sentiment(text):
        ...
        try:
            # Assuming Granite returns JSON-formatted string
            import json
    ...
    def parse_resume(pdf_file):
        try:
            # Create a PDF reader object directly from the uploaded file
            with pdfplumber.open(pdf_file) as pdf_reader:
                ...
                print(f"Extracted text sample: {cleaned_text[:200]}...")  # Debug print
                ...
                You may find random combinations of aplhabets and numbers like 'cd321232134' just ignore those. 
                A candidate is unlikely to put their ID in a resume so don't label stuff as ID it could just be a random combination like I mentioned before.
                Only mention things like linkedin or gmail etc if there is a clear url or email given otherwise don't (extremely high emphasis on this do not include linkedin if it is a random combination of letters and numbers only inlude it if is a clear url and you are most certain that it indeed is  a url).
                If there are any projects you can summarize them as well.
                """
...
class SalaryManagement:
    ...
    def update_salary(employee_id, basic_pay):
        # Add effective_date to track salary history
        data = {
            'basic_pay': basic_pay,
...
def main():
    ...
    if page == "Employee Management":
        ...
        with tab2:
            ...
            try:
                ...
                if attendance.data:
                    ...
                    # Extract employee name from the nested employees object
        ...
        if uploaded_file is not None:
            try:
                # Process the resume directly with the file
